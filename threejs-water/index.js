const canvas = document.getElementById('canvas-water');
...
// Shader chunks
loadFile('threejs-water/shaders/utils.glsl').then((utils) => {
  ...
  // Light direction
  const light = [0.1559289460184544, 0.7559289460184544, -0.1779644730092272];
  ...
  const textureCube = cubetextureloader.load([
    'threejs-water/xpos.jpg', 'threejs-water/xneg.jpg',
    'threejs-water/ypos.jpg', 'threejs-water/ypos.jpg',
    'threejs-water/zpos.jpg', 'threejs-water/zneg.jpg',
  ]);

  const textureloader = new THREE.TextureLoader();

  const tiles = textureloader.load('threejs-water/tiles.jpg');
  ...
  class WaterSimulation {
    ...
    constructor() {
      ...
      const shadersPromises = [
        loadFile('threejs-water/shaders/simulation/vertex.glsl'),
        loadFile('threejs-water/shaders/simulation/drop_fragment.glsl'),
        loadFile('threejs-water/shaders/simulation/normal_fragment.glsl'),
        loadFile('threejs-water/shaders/simulation/update_fragment.glsl'),
      ];
  ...
  class Caustics {
    ...
    constructor(lightFrontGeometry) {
      ...
      const shadersPromises = [
        loadFile('threejs-water/shaders/caustics/vertex.glsl'),
        loadFile('threejs-water/shaders/caustics/fragment.glsl')
      ];
  ...
  class Water {
    ...
    constructor() {
      ...
      const shadersPromises = [
        loadFile('threejs-water/shaders/water/vertex.glsl'),
        loadFile('threejs-water/shaders/water/fragment.glsl')
      ];
  ...
  class Pool {
    ...
    constructor() {
      ...
      const shadersPromises = [
        loadFile('threejs-water/shaders/pool/vertex.glsl'),
        loadFile('threejs-water/shaders/pool/fragment.glsl')
      ];
  ...
  class Debug {
    ...
    constructor() {
      ...
      const shadersPromises = [
        loadFile('threejs-water/shaders/debug/vertex.glsl'),
        loadFile('threejs-water/shaders/debug/fragment.glsl')
      ];
  ...
  Promise.all(loaded).then(() => {
    canvas.addEventListener('mousedown', { handleEvent: startDrag });
    canvas.addEventListener('mousemove', { handleEvent: duringDrag });
    canvas.addEventListener('mouseup', { handleEvent: stopDrag });
